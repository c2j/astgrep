...
| 字段 | Semgrep | astgrep | 兼容性 | 备注 |
|------|---------|---------------|--------|------|
| id | ✅ | ✅ | 100% | 规则唯一标识 |
| message | ✅ | ✅ | 100% | 错误消息 |
| name | ❌ | ✅ | 单向 | astgrep 扩展 |
| description | ❌ | ✅ | 单向 | astgrep 扩展 |
