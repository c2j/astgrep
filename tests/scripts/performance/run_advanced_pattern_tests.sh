...
test_all_patterns() {
    ...
    test_pattern_type "Pattern-Either" \
        "tests/categories/advanced_patterns/pattern_either_test.yaml" \
        "tests/categories/advanced_patterns/pattern_either_test.py" \
        8

    # Test 2: Pattern-Not
    test_pattern_type "Pattern-Not" \
        "tests/categories/advanced_patterns/pattern_not_test.yaml" \
        "tests/categories/advanced_patterns/pattern_not_test.py" \
        10

    # Test 3: Pattern-Inside
    test_pattern_type "Pattern-Inside" \
        "tests/categories/advanced_patterns/pattern_inside_test.yaml" \
        "tests/categories/advanced_patterns/pattern_inside_test.py" \
        14

    # Test 4: Pattern-Regex
    test_pattern_type "Pattern-Regex" \
        "tests/categories/advanced_patterns/pattern_regex_test.yaml" \
        "tests/categories/advanced_patterns/pattern_regex_test.py" \
        20

    # Test 5: Metavariables
    test_pattern_type "Metavariables" \
        "tests/categories/advanced_patterns/metavariables_test.yaml" \
        "tests/categories/advanced_patterns/metavariables_test.py" \
        20
}
...
run_performance_comparison() {
    ...
    semgrep --config tests/categories/advanced_patterns/pattern_either_test.yaml tests/categories/advanced_patterns/pattern_either_test.py --quiet > /dev/null 2>&1 || true
    semgrep --config tests/categories/advanced_patterns/pattern_not_test.yaml tests/categories/advanced_patterns/pattern_not_test.py --quiet > /dev/null 2>&1 || true
    semgrep --config tests/categories/advanced_patterns/pattern_inside_test.yaml tests/categories/advanced_patterns/pattern_inside_test.py --quiet > /dev/null 2>&1 || true
