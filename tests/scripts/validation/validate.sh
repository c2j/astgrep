...
run_quick() {
    ...
    python3 "$TESTS_DIR/scripts/utils/quick_validation.py"
}

# Full validation
run_full() {
    echo -e "${BLUE}Running Full Validation Suite...${NC}\n"
    bash "$TESTS_DIR/scripts/validation/run_validation_suite.sh"
}
...
run_report() {
    ...
    python3 "$TESTS_DIR/scripts/utils/generate_detailed_report.py"
