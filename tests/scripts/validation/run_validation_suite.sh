...
if python3 "$TESTS_DIR/scripts/utils/quick_validation.py"; then
...
if python3 "$TESTS_DIR/scripts/utils/comprehensive_test_runner.py"; then
...
if python3 "$TESTS_DIR/scripts/utils/test_analyzer.py"; then
...
For more details, run:
  python3 $TESTS_DIR/scripts/utils/test_analyzer.py
EOF
