...
impl NodeType {
    ...
    pub fn parse_name(s: &str) -> Option<Self> {
        match s {
            ...
            "predict_statement" => Some(NodeType::PredictStatement),
            "timecapsule_statement" => Some(NodeType::TimecapsuleStatement),
            "shrink_statement" => Some(NodeType::ShrinkStatement),
...
mod tests {
    ...
    fn test_all_node_type_roundtrip() {
        let all = vec![
            ...
            NodeType::DropStatement,
            NodeType::AlterStatement,
            NodeType::PredictStatement,
            NodeType::TimecapsuleStatement,
            NodeType::ShrinkStatement,
            NodeType::Shebang,
            NodeType::ExportStatement,
            NodeType::SourceStatement,
            NodeType::Command,
