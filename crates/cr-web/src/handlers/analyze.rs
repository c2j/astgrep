...
use cr_rules::{RuleEngine, RuleContext};
...
async fn perform_code_analysis(
    ...
    let web_findings: Vec<Finding> = findings.into_iter().map(|f| Finding {
        ...
        location: Location {
            ...
            snippet: None, // cr_core::Location doesn't have snippet field
        },
...
async fn perform_dataflow_analysis(
    _ast: &dyn cr_core::traits::AstNode,
    context: &RuleContext,
    language: Language,
) -> WebResult<Vec<cr_core::Finding>> {
    ...
    match language {
        Language::Java => {
            ...
            let finding = cr_core::Finding {
                ...
                severity: cr_core::Severity::Error,
                confidence: cr_core::Confidence::Medium,
                location: cr_core::Location {
    ...
    match language {
        ...
        Language::JavaScript => {
            findings.push(cr_core::Finding {
                ...
                severity: cr_core::Severity::Critical,
                confidence: cr_core::Confidence::High,
                location: cr_core::Location {
                    file: context.file_path.clone().into(),
                    start_line: 1,
                    start_column: 1,
    ...
    match language {
        Language::Java => {
            findings.push(cr_core::Finding {
                ...
                severity: cr_core::Severity::Warning,
                confidence: cr_core::Confidence::Medium,
                location: cr_core::Location {
                    file: context.file_path.clone().into(),
                    start_line: 1,
        ...
        Language::JavaScript => {
            findings.push(cr_core::Finding {
                ...
                severity: cr_core::Severity::Warning,
                confidence: cr_core::Confidence::Low,
                location: cr_core::Location {
                    file: context.file_path.clone().into(),
                    start_line: 1,
                    start_column: 1,
