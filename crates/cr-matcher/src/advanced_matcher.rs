...
use cr_core::{AstNode, Result, AnalysisError, SemgrepPattern, PatternType, Condition, MetavariableRegex, MetavariableComparison, ComparisonOperator, SemgrepMatchResult};
...
mod tests {
    use super::*;
    use cr_core::{SemgrepPattern, PatternType};
    use cr_ast::UniversalNode;
