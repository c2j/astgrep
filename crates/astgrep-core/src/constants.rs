//! Configuration constants for astgrep
//!
...
pub mod defaults {
    ...
    pub mod server {
        ...
        pub const TEMP_DIRECTORY: &str = "/tmp/astgrep";
...
pub mod paths {
    ...
    pub const CONFIG_FILE: &str = "astgrep.toml";

    /// Default web configuration file name
    pub const WEB_CONFIG_FILE: &str = "astgrep-web.toml";

    /// Default log file name
    pub const LOG_FILE: &str = "astgrep.log";
...
pub mod metadata {
    /// Application name
    pub const APP_NAME: &str = "astgrep";

    /// Application description
    pub const APP_DESCRIPTION: &str = "Static Code Analysis Service";

    /// Default user agent
    pub const USER_AGENT: &str = "astgrep/1.0";
