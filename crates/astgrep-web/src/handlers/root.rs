...
<body>
    <h1 class="header">🔍 astgrep API</h1>
    <p>Welcome to the astgrep REST API - Advanced Static Code Analysis</p>
    ...
    <footer style="margin-top: 40px; color: #6c757d; font-size: 0.9em;">
        <p>astgrep v{version} | Built with Rust & Axum</p>
    </footer>
</body>
</html>
