...
fn show_general_info() {
    ...
    println!("  • User Guide: https://github.com/your-org/astgrep/docs");
    println!("  • API Reference: https://docs.rs/astgrep");
    println!("  • Rule Writing: https://github.com/your-org/astgrep/wiki/rules");
    println!();

    println!("💡 Quick Start:");
    println!("  1. Initialize config: astgrep init");
    println!("  2. Analyze code: astgrep analyze src/");
    println!("  3. View rules: astgrep list --detailed");
    println!("  4. Get help: astgrep --help");
}
...
fn show_rule_categories() {
    ...
    println!();
    println!("💡 Use 'astgrep list --category <name>' to see rules in a specific category.");
