...
use cr_core::constants::{defaults, paths};
...
pub async fn run(output: PathBuf, template: String, force: bool) -> Result<()> {
    ...
    println!("🚀 Run analysis with: cr-semservice analyze --config {}", output.display());
...
fn generate_minimal_config() -> String {
    format!(
        "# Minimal CR-SemService Configuration\n\
        \n\
        [general]\n\
        verbose = false\n\
        \n\
...
fn generate_comprehensive_config() -> String {
    format!(
        "# Comprehensive CR-SemService Configuration\n\
        \n\
        [general]\n\
        verbose = true\n\
        threads = 4\n\
...
fn generate_security_focused_config() -> String {
    format!(
        "# Security-Focused CR-SemService Configuration\n\
        \n\
        [general]\n\
        verbose = true\n\
        threads = 0\n\
...
fn generate_performance_focused_config() -> String {
    format!(
        "# Performance-Focused CR-SemService Configuration\n\
        \n\
        [general]\n\
        verbose = false\n\
        threads = 0\n\
